<div class="container-fluid psion">
  <div class="boxcreate col-12">
    <label class="headtitle">EDIT BOOK TRX</label>
    <?php
...
?>
    ...
    <?php 
			...
			?>
      <form enctype="multipart/form-data"  method="post" action="<?= base_url("BookTrx/saveEdit/"); ?>">
      <input type="hidden" class="form-control" value="<?= $booktrx->id ?>" id="id" name="id">
      <div class="form-group f1">
          <label for="book_id">ID BOOK</label>
          <select class="form-select" name="book_id">
          <option value="<?= $booktrx->id ?>" selected><?= $booktrx->title ?></option>
        ...
        <div class="form-group f1">
          ...
          <option value="<?= $booktrx->id ?>" selected><?= $booktrx->full_name ?></option>
        ...
        <div class="form-group f1">
          ...
          <option value="<?= $booktrx->id ?>" selected><?= $booktrx->id ?> DEADLINE DATE : <?= $booktrx->deadline_at ?></option>
        ...
        <div class="form-group f1">
          ...
          <option value="<?= $booktrx->type ?>" selected><?= $booktrx->type ?></option>
