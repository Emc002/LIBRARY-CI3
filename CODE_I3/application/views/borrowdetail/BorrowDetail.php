<div class="col-lg-10 divtwo">
	<div class="row setting noxy">
		...
		<div class="col-lg-12 box6 nox table-responsive">
			<h4>BORROW DETAIL TABLE</h4>
			<table class="table librarianTable table-light table-info table-hover table-bordered">
				<a href="<?= base_url('BorrowDetail/add'); ?>" type="button" class="btn btn-secondary">ADD BORROW DETAIL</a>
				<thead>
					<tr>
						<th>NO</th>
						<th>TITLE</th>
              ...
              <td>
							...
							<td>
								<a href="<?php echo base_url(); ?>BorrowDetail/edit/<?php echo $td->id; ?>" type="button" class="btn btn-warning">EDIT</a>
								<a href="<?php echo base_url(); ?>BorrowDetail/delete/<?php echo $td->id; ?>" type="button" class="btn btn-danger">DELETE</a>
							</td>
						</tr>
					<?php
					}
...
<script>
	 let s1 = document.querySelector('#s8')
